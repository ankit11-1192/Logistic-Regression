...
ad$Dependents[is.na(ad$Dependents)] = median(ad$Dependents, na.rm = T)
ad$zero[is.na(ad$zero)] = median(ad$zero, na.rm = T)
ad$two[is.na(ad$two)] = median(ad$two, na.rm = T)
ad$three[is.na(ad$three)] = median(ad$three, na.rm = T)
str(ad)
summary(ad)
